...
import Toy1 from "../../assets/toys/toys1.jpg";
import Toy2 from "../../assets/toys/toys2.jpg";
import Toy3 from "../../assets/toys/toys3.jpg";

const KidsToy = ({ product }) => {
  const { addToCart } = useCart(); 
  const images = [Toy1, Toy2, Toy3];
  ...
  if (!product) {
    product = {
      id: 1, 
      title: "Fun Kids Toy Set",
      price: 60,
      description: "Exciting toy set for kids including multiple colorful pieces for learning and fun.",
    };
  }
